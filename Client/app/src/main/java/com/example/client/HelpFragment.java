...
import com.example.client.dto.Topic;
import com.example.client.dto.TopicsResponse;
 ...
 */
public class HelpFragment extends Fragment implements RecyclerViewAdapter.OnTopicListener {

    RecyclerView recyclerView;
    com.example.client.RecyclerViewAdapter recyclerViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = root.findViewById(R.id.recyclerViewHelp);
    ...
    private void populateData(String societyId, int flag) {
        compositeDisposable.add(iMyService.getComplains(societyId, flag)
